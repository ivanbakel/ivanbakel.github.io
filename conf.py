...
BLOG_AUTHOR = "Isaac van Bakel"  # (translatable)
BLOG_TITLE = "Personal Website"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ivanbakel.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ivanbakel.github.io/"
BLOG_EMAIL = "ivb@vanbakel.io"
BLOG_DESCRIPTION = "A portfolio and content website."  # (translatable)
